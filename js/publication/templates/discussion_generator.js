    ...
    function generateDiscussion(aggregatedData, lang = 'de') {
        ...
        if (lang === 'de') {
            ...
            return `
                ...
                <p>Improved accuracy of preoperative N-staging through integration of the AS could be particularly relevant in the context of individualized treatment concepts. These include the selection of patients for organ-preserving strategies (e.g., "watch-and-wait" approach) or decisions regarding the intensity and type of neoadjuvant therapy [4,5]. The ability to more reliably predict lymph node status could help reduce both overtreatment and undertreatment.</p>
