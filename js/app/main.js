...
function handleTabShown(tabId) {
    ...
    switch (tabId) {
        ...
        case 'publikation-tab': viewRenderer.renderPublikationTab(state.getCurrentPublikationLang(), state.getCurrentPublikationSection(), currentKollektiv, localRawData, lastBruteForceResults); break;
