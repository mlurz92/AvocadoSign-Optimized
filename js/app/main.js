...
function handleBodyClickDelegation(event) {
    ...
    if (closestHeader && (!closestSubHeader || !target.closest('.sortable-sub-header'))) { handleSortClick(closestHeader, null); return; }
    if (closestSubHeader) { handleSortClick(closestHeader, closestSubHeader); return; }
