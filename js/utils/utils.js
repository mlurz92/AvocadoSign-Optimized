const utils = (() => {
    ...
    function getStatisticalSignificanceSymbol(pValue) {
        ...
        if (typeof APP_CONFIG === 'undefined' || !APP_CONFIG.STATISTICAL_CONSTANTS) return '';
        ...
        if (!significanceLevels || !overallSignificanceLevel) return '';
    ...
    function getStatisticalSignificanceText(pValue, significanceLevel) {
        if (pValue === null || pValue === undefined || isNaN(pValue) || !isFinite(pValue)) return '';
        if (typeof APP_CONFIG === 'undefined' || !APP_CONFIG.STATISTICAL_CONSTANTS || typeof UI_TEXTS === 'undefined' || !UI_TEXTS.statMetrics) return '';
    ...
    function getPValueText(pValue, lang = 'de') {
        ...
        if (typeof APP_CONFIG === 'undefined' || !APP_CONFIG.STATISTICAL_CONSTANTS) return `p = ${String(pValue)}`;
    ...
    function getAUCBewertung(aucValue) {
        ...
        if (typeof UI_TEXTS === 'undefined' || !UI_TEXTS.statMetrics) return 'N/A';
    ...
    return Object.freeze({
        ...
        getStatisticalSignificanceText,
        getPValueText,
        generateUUID,
        clampNumber,
        arraysAreEqual,
