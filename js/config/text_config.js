...
const TOOLTIP_CONTENT = {
    ...
    statMetrics: {
        ...
        defaultP: { interpretation: { de: `Der berechnete p-Wert beträgt <strong>[P_WERT] ([SIGNIFIKANZ])</strong>. Bei einem Signifikanzniveau von ${typeof APP_CONFIG !== 'undefined' ? APP_CONFIG.STATISTICAL_CONSTANTS.SIGNIFICANCE_LEVEL : '0.05'} ist das Ergebnis <strong>[SIGNIFIKANZ_TEXT_DE]</strong>.`, en: `The calculated p-value is <strong>[P_WERT] ([SIGNIFIKANZ_EN])</strong>. At a significance level of ${typeof APP_CONFIG !== 'undefined' ? APP_CONFIG.STATISTICAL_CONSTANTS.SIGNIFICANCE_LEVEL : '0.05'}, the result is <strong>[SIGNIFIKANZ_TEXT_EN]</strong>.` } }
    }
};
