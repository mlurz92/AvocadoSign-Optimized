...
const TOOLTIP_CONTENT = {
    ...
    datenTable: {
        ...
        therapie: { de: "Angewandte Therapie vor der Operation (nRCT: neoadjuvante Radiochemotherapie, direkt OP: keine Vorbehandlung).", en: "Applied therapy before surgery (nRCT: neoadjuvant chemoradiotherapy, direkt OP: no pretreatment)." },
    ...
    t2Size: { description: { de: `Größenkriterium: Lymphknoten mit einem Kurzachsendurchmesser <strong>größer oder gleich</strong> dem eingestellten Schwellenwert gelten als suspekt. Einstellbarer Bereich: ${typeof APP_CONFIG !== 'undefined' ? APP_CONFIG.T2_CRITERIA_SETTINGS.SIZE_RANGE.min : '0.1'} - ${typeof APP_CONFIG !== 'undefined' ? APP_CONFIG.T2_CRITERIA_SETTINGS.SIZE_RANGE.max : '25.0'} mm. Aktivieren/Deaktivieren Sie das Kriterium mit der Checkbox.`, en: `Size criterion: Lymph nodes with a short-axis diameter <strong>greater than or equal to</strong> the set threshold are considered suspicious. Adjustable range: ${typeof APP_CONFIG !== 'undefined' ? APP_CONFIG.T2_CRITERIA_SETTINGS.SIZE_RANGE.min : '0.1'} - ${typeof APP_CONFIG !== 'undefined' ? APP_CONFIG.T2_CRITERIA_SETTINGS.SIZE_RANGE.max : '25.0'} mm. Activate/deactivate the criterion using the checkbox.`} },
    ...
    statMetrics: {
        ...
        ppv: { name: { de: "Pos. Prädiktiver Wert (PPV)", en: "Positive Predictive Value (PPV)" }, description: { de: "PPV ([METHODE] vs. N): Wahrscheinlichkeit, dass ein Patient mit einem positiven Testergebnis durch Methode [METHODE] tatsächlich krank (N+) ist.<br><i>Formel: RP / (RP + FP)</i>", en: "PPV ([METHODE] vs. N): Probability that a patient with a positive test result by method [METHODE] is actually N+.<br><i>Formula: TP / (TP + FP)</i>" }, interpretation: { de: "Wenn die Methode [METHODE] ein positives Ergebnis lieferte, lag die Wahrscheinlichkeit für einen tatsächlichen N+ Status bei <strong>[WERT]</strong> (95% KI nach [METHOD_CI]: [LOWER] - [UPPER]) im Kollektiv [KOLLEKTIV].", en: "If method [METHODE] yielded a positive result, the probability of an actual N+ status was <strong>[WERT]</strong> (95% CI by [METHOD_CI]: [LOWER] - [UPPER]) in cohort [KOLLEKTIV]." } },
        ...
        defaultP: { interpretation: { de: `Der berechnete p-Wert beträgt <strong>[P_WERT] ([SIGNIFIKANZ])</strong>. Bei einem Signifikanzniveau von ${typeof APP_CONFIG !== 'undefined' && APP_CONFIG.STATISTICAL_CONSTANTS ? APP_CONFIG.STATISTICAL_CONSTANTS.SIGNIFICANCE_LEVEL : '0.05'} ist das Ergebnis <strong>[SIGNIFIKANZ_TEXT_DE]</strong>.`, en: `The calculated p-value is <strong>[P_WERT] ([SIGNIFIKANZ_EN])</strong>. At a significance level of ${typeof APP_CONFIG !== 'undefined' && APP_CONFIG.STATISTICAL_CONSTANTS ? APP_CONFIG.STATISTICAL_CONSTANTS.SIGNIFICANCE_LEVEL : '0.05'}, the result is <strong>[SIGNIFIKANZ_TEXT_EN]</strong>.` } }
    }
};
