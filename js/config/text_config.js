...
const UI_TEXTS = {
    kollektivDisplayNames: {
        ...
        'direkt OP': {
            de: 'Direkt OP',
            en: 'Surgery alone group'
        },
        'nRCT': {
            de: 'nRCT',
            en: 'Neoadjuvant therapy group'
        },
        'avocado_sign': {
            de: 'Avocado Sign',
            en: 'Avocado Sign'
    ...
    publikationTab: {
        ...
        subSectionLabels: {
            methoden_studienanlage: { de: 'Studiendesign und Ethik', en: 'Study Design and Ethics' },
            methoden_patientenkollektiv: { de: 'Patientenkollektiv', en: 'Patient Cohort' },
            methoden_mrt_protokoll: { de: 'MRT-Protokoll & Kontrastmittelgabe', en: 'MRI Protocol & Contrast Administration' },
            methoden_as_definition: { de: 'Definition & Bewertung Avocado Sign', en: 'Definition & Assessment of the Avocado Sign' },
            methoden_t2_definition: { de: 'Definition & Bewertung T2-Kriterien', en: 'Definition & Assessment of T2 Criteria' },
            methoden_referenzstandard: { de: 'Referenzstandard (Histopathologie)', en: 'Reference Standard (Histopathology)' },
            methoden_statistische_analyse: { de: 'Statistische Analyse', en: 'Statistical Analysis' },
            ergebnisse_patientencharakteristika: { de: 'Patientencharakteristika', en: 'Patient Characteristics' },
            ergebnisse_as_performance: { de: 'Diagnostische Güte: Avocado Sign', en: 'Diagnostic Performance: Avocado Sign' },
            ergebnisse_literatur_t2_performance: { de: 'Diagnostische Güte: Literatur-T2-Kriterien', en: 'Diagnostic Performance: Literature-Based T2 Criteria' },
            ergebnisse_optimierte_t2_performance: { de: 'Diagnostische Güte: Optimierte T2-Kriterien (Brute-Force)', en: 'Diagnostic Performance: Optimized T2 Criteria (Brute-Force)' },
            ergebnisse_vergleich_performance: { de: 'Vergleich: AS vs. T2-Kriterien', en: 'Comparison: AS vs. T2 Criteria' }
        },
        publicationTableTitles: {
            literaturT2Kriterien: { de: 'Tabelle 2: Übersicht der Literatur-basierten T2-Kriteriensets', en: 'Table 2: Overview of Literature-Based T2 Criteria Sets' },
            patientenCharakteristika: { de: 'Tabelle 1: Patientencharakteristika', en: 'Table 1: Patient Characteristics' },
            diagnostischeGueteAS: { de: 'Tabelle 3: Diagnostische Güte - Avocado Sign (vs. N-Status)', en: 'Table 3: Diagnostic Performance - Avocado Sign (vs. N-Status)' },
            diagnostischeGueteLiteratur: { de: 'Tabelle 4: Diagnostische Güte - Literatur-basierte T2-Kriterien (vs. N-Status)', en: 'Table 4: Diagnostic Performance - Literature-Based T2 Criteria (vs. N-Status)' },
            diagnostischeGueteBF: { de: 'Tabelle 5: Diagnostische Güte - Optimierte T2-Kriterien (Ziel: {METRIC}, vs. N-Status)', en: 'Table 5: Diagnostic Performance - Optimized T2 Criteria (Target: {METRIC}, vs. N-Status)' },
            statistischerVergleich: { de: 'Tabelle 6: Statistischer Vergleich - Avocado Sign vs. T2-Kriterien (Literatur und Optimiert)', en: 'Table 6: Statistical Comparison - Avocado Sign vs. T2 Criteria (Literature and Optimized)' }
        },
        publicationChartTitles: {
            alterGesamt: { de: 'Altersverteilung (Gesamtkollektiv)', en: 'Age Distribution (Overall Cohort)' },
            genderGesamt: { de: 'Geschlechterverteilung (Gesamtkollektiv)', en: 'Gender Distribution (Overall Cohort)' },
            vergleichMetriken: { de: 'Vergleichsmetriken für {COHORT}', en: 'Comparative Metrics for {COHORT}' }
        },
        publicationFigureCaptions: {
            fig1a: { de: 'Abb. 1a', en: 'Fig. 1a' },
            fig1b: { de: 'Abb. 1b', en: 'Fig. 1b' },
            fig2a: { de: 'Abb. 2a', en: 'Fig. 2a' },
            fig2b: { de: 'Abb. 2b', en: 'Fig. 2b' },
            fig2c: { de: 'Abb. 2c', en: 'Fig. 2c' }
        },
        publicationMisc: {
            noData: { de: 'Keine Daten verfügbar.', en: 'No data available.' },
            noValidData: { de: 'Keine validen Daten', en: 'No valid data' },
            notApplicableShort: { de: 'N/A', en: 'N/A' },
            appliedCohort: { de: 'Angew. Kollektiv', en: 'Applied Cohort' },
            method: { de: 'Methode', en: 'Method' },
            cohort: { de: 'Kollektiv', en: 'Cohort' },
            criteriaSet: { de: 'Kriteriensatz', en: 'Criteria Set' },
            optimizationTarget: { de: 'Optimierungs-Ziel', en: 'Optimization Target' },
            comparison: { de: 'Vergleich', en: 'Comparison' },
            aucDiff: { de: 'Diff. AUC (M1-M2)', en: 'AUC Diff. (M1-M2)' },
            pValueAUC: { de: 'DeLong p-Wert (AUC)', en: 'DeLong p-value (AUC)' },
            pValueAcc: { de: 'McNemar p-Wert (Acc.)', en: 'McNemar p-value (Acc.)' }
        }
    },
    chartTitles: {
        ...
        statusN: { de: 'N-Status (Patho)', en: 'N-Status (Pathology)' },
    ...
    legendLabels: {
        ...
        benignLN: { de: 'Benigne LK', en: 'Benign LNs' },
        malignantLN: { de: 'Maligne LK', en: 'Malignant LNs' }
    },
    criteriaComparison: {
    ...
    excelExport: {
        datenLabel: { de: "Datenliste (.xlsx)", en: "Data List (.xlsx)" },
        auswertungLabel: { de: "Auswertungstabelle (.xlsx)", en: "Evaluation Table (.xlsx)" },
        statistikLabel: { de: "Statistik Übersicht (.xlsx)", en: "Statistics Overview (.xlsx)" },
        filteredDataLabel: { de: "Gefilterte Daten (.xlsx)", en: "Filtered Data (.xlsx)" },
        zipLabel: { de: "Alle Excel-Tabellen (.zip)", en: "All Excel Sheets (.zip)" }
    },
    singleChartDownload: {
...
const TOOLTIP_CONTENT = {
    ...
    datenTable: {
        ...
        therapie: { de: "Angewandte Therapie vor der Operation (nRCT: neoadjuvante Radiochemotherapie, direkt OP: keine Vorbehandlung).", en: "Applied therapy before surgery (nRCT: neoadjuvant chemoradiotherapy, direkt OP: no
        pretreatment)." },
        ...
        expandAll: { de: "Öffnet oder schließt die Detailansicht zu den T2-gewichteten Lymphknotenmerkmalen für alle Patienten in der aktuellen Tabellenansicht.", en: "Expands or collapses the detail view of T2-weighted lymph node characteristics for all patients in the current table view." },
    ...
    auswertungTable: {
        ...
        expandAll: { de: "Öffnet oder schließt die Detailansicht der bewerteten T2-gewichteten Lymphknoten und der erfüllten Kriterien für alle Patienten in der aktuellen Tabellenansicht.", en: "Expands or collapses the detail view of evaluated T2-weighted lymph nodes and fulfilled criteria for all patients in the current table view." },
    ...
    t2MetricsOverview: {
        cardTitle: { de: "Kurzübersicht der diagnostischen Güte für die aktuell angewendeten und gespeicherten T2-Kriterien im Vergleich zum histopathologischen N-Status für das gewählte Kollektiv: [KOLLEKTIV].", en: "Summary of diagnostic performance for the currently applied and saved T2 criteria compared to the histopathological N-status for the selected cohort: [KOLLEKTIV]." },
    ...
    bruteForceStart: { description: { de: "Startet die exhaustive Suche (Brute-Force) nach der optimalen Kombination von T2-Kriterien (aktive Kriterien, Werte, Logik), die die gewählte Zielmetrik maximiert. Dies testet alle sinnvollen Kombinationen und kann je nach Kollektivgröße einige Minuten dauern. Der Prozess läuft im Hintergrund.", en: "Starts the exhaustive search (brute-force) for the optimal combination of T2 criteria (active criteria, values, logic) that maximizes the selected target metric. This tests all meaningful combinations and can take several minutes depending on cohort size. The process runs in the background." } },
    bruteForceInfo: { description: { de: "Zeigt den Status des Optimierungs-Workers und das aktuell für die Analyse ausgewählte Patientenkollektiv an.", en: "Displays the status of the optimization worker and the currently selected patient cohort for analysis." } },
    bruteForceProgress: { description: { de: "Zeigt den Fortschritt der laufenden Optimierung an: Anzahl bereits getesteter Kombinationen von insgesamt zu testenden [TOTAL], sowie die bisher beste gefundene Metrik mit den zugehörigen Kriterien und der Logik.", en: "Displays the progress of the ongoing optimization: Number of combinations already tested out of a total of [TOTAL] to be tested, as well as the best metric found so far with the associated criteria and logic." } },
    bruteForceResult: { description: { de: "Zeigt das Ergebnis der abgeschlossenen Optimierung an: die beste gefundene Kriterienkombination (Logik, aktive Kriterien, Werte) und den damit erreichten Wert der Zielmetrik für das analysierte Kollektiv.", en: "Displays the result of the completed optimization: the best found criteria combination (logic, active criteria, values) and the achieved value of the target metric for the analyzed cohort." } },
    bruteForceDetailsButton: { description: { de: "Öffnet ein separates Fenster (Modal), das eine sortierte Liste der Top 10 gefundenen Kriterienkombinationen (inklusive solcher mit gleichem Metrikwert) und weitere Details zur Optimierung anzeigt.", en: "Opens a separate window (modal) displaying a sorted list of the top 10 found criteria combinations (including those with the same metric value) and further details about the optimization." } },
    ...
    statistikToggleVergleich: { description: { de: "Schaltet zwischen der Ansicht für ein einzelnes, global gewähltes Kollektiv und der Vergleichsansicht zweier spezifisch wählbarer Kollektive um.", en: "Toggles between the view for a single, globally selected cohort and the comparison view of two specifically selectable cohorts." } },
    deskriptiveStatistik: {
        ...
        lkAnzahlT2Plus: { description: { de: "Median (Minimum-Maximum) [Mittelwert ± Standardabweichung] der Anzahl als positiv bewerteter T2-Lymphknoten (T2+, gemäß angewendeter Kriterien) pro Patient, *nur* bezogen auf die Patienten, die T2+ waren.", en: "Median (Minimum-Maximum) [Mean ± Standard Deviation] of the number of T2 positive (T2+, according to applied criteria) lymph nodes per patient, *only* for patients who were T2+." } },
        chartAge: { description: { de: "Histogramm der Altersverteilung der Patienten im Kollektiv [KOLLEKTIV].", en: "Histogram of the age distribution of patients in cohort [KOLLEKTIV]." } },
        chartGender: { description: { de: "Tortendiagramm der Geschlechterverteilung (m/w) im Kollektiv [KOLLEKTIV].", en: "Pie chart of the gender distribution (m/f) in cohort [KOLLEKTIV]." } }
    },
    diagnostischeGueteAS: { cardTitle: { de: "Diagnostische Gütekriterien für das Avocado Sign (AS) im Vergleich zur Histopathologie (N) als Referenzstandard für das Kollektiv [KOLLEKTIV]. Alle Werte inkl. 95% Konfidenzintervall.", en: "Diagnostic performance criteria for the Avocado Sign (AS) compared to histopathology (N) as the reference standard for cohort [KOLLEKTIV]. All values include 95% confidence interval." } },
    diagnostischeGueteT2: { cardTitle: { de: "Diagnostische Gütekriterien für die aktuell angewendeten T2-Kriterien im Vergleich zur Histopathologie (N) als Referenzstandard für das Kollektiv [KOLLEKTIV]. Alle Werte inkl. 95% Konfidenzintervall.", en: "Diagnostic performance criteria for the currently applied T2 criteria compared to histopathology (N) as the reference standard for cohort [KOLLEKTIV]. All values include 95% confidence interval." } },
    statistischerVergleichASvsT2: { cardTitle: { de: "Direkter statistischer Vergleich der diagnostischen Leistung von AS vs. T2 (aktuell angewendete Kriterien) innerhalb desselben Kollektivs ([KOLLEKTIV]) mittels gepaarter Tests.", en: "Direct statistical comparison of the diagnostic performance of AS vs. T2 (currently applied criteria) within the same cohort ([KOLLEKTIV]) using paired tests." } },
    ...
    praesentation: {
        ...
        comparisonTableCard: { description: { de: "Zeigt die numerischen Werte der diagnostischen Gütekriterien für den Vergleich von Avocado Sign vs. ausgewählter T2-Basis für das aktuelle Kollektiv.", en: "Displays the numerical values of the diagnostic performance criteria for the comparison of Avocado Sign vs. selected T2 basis for the current cohort." } },
        downloadDemographicsMD: { description: { de: "Lädt die Tabelle der demographischen Basisdaten (nur für Avocado-Sign-Ansicht) als Markdown-Datei (.md) herunter.", en: "Downloads the table of demographic baseline data (only for Avocado Sign view) as a Markdown file (.md)." } },
        downloadPerformanceCSV: { description: { de: "Lädt die Tabelle der diagnostischen Güte (je nach Ansicht: AS oder AS vs. ausgewählte T2-Basis) als CSV-Datei (.csv) herunter.", en: "Downloads the table of diagnostic performance (depending on view: AS or AS vs. selected T2 basis) as a CSV file (.csv)." } },
        downloadPerformanceMD: { description: { de: "Lädt die Tabelle der diagnostischen Güte (je nach Ansicht: AS oder AS vs. ausgewählte T2-Basis) als Markdown-Datei (.md) herunter.", en: "Downloads the table of diagnostic performance (depending on view: AS or AS vs. selected T2 basis) as a Markdown file (.md)." } },
        ...
        asPurPerfTable: {
            kollektiv: { de: "Patientenkollektiv (Gesamt, Direkt OP, nRCT). N = Anzahl Patienten in der Gruppe.", en: "Patient cohort (Overall, Upfront Surgery, nRCT). N = number of patients in the group." },
    ...
    exportTab: {
        ...
        allZIP: { description: { de: "Exportiert alle verfügbaren Einzeldateien (Statistik-CSV, BruteForce-TXT, alle MDs, Gefilterte-Daten-CSV, HTML-Report) in einem einzigen ZIP-Archiv.", en: "Exports all available individual files (Statistics CSV, BruteForce TXT, all MDs, Filtered Data CSV, HTML Report) in a single ZIP archive." }, type: 'ALL_ZIP', ext: "zip"},
        csvZIP: { description: { de: "Bündelt alle verfügbaren CSV-Dateien (Statistik, Gefilterte Daten) in einem ZIP-Archiv.", en: "Bundles all available CSV files (Statistics, Filtered Data) in a ZIP archive." }, type: 'CSV_ZIP', ext: "zip"},
        mdZIP: { description: { de: "Bündelt alle verfügbaren Markdown-Dateien (Deskriptiv, Daten, Auswertung, Publikationstexte) in einem ZIP-Archiv.", en: "Bundles all available Markdown files (Descriptive, Data, Evaluation, Publication Texts) in a ZIP archive." }, type: 'MD_ZIP', ext: "md"},
        pngZIP: { description: { de: "Identisch zum 'Alle Diagramme & Tabellen (PNG)' Einzel-Export.", en: "Identical to 'All Charts & Tables (PNG)' single export." }, type: 'PNG_ZIP', ext: "zip"},
        svgZIP: { description: { de: "Identisch zum 'Alle Diagramme (SVG)' Einzel-Export.", en: "Identical to 'All Charts (SVG)' single export." }, type: 'SVG_ZIP', ext: "zip"},
        xlsxZIP: { description: { de: "Bündelt alle verfügbaren Excel-Dateien in einem ZIP-Archiv.", en: "Bundles all available Excel files in a ZIP archive." }, type: 'XLSX_ZIP', ext: "zip"}
    },
    publikationTabTooltips: {
        spracheSwitch: { description: { de: "Wechselt die Sprache der Texte und Beschriftungen im Publikation-Tab zwischen Deutsch und Englisch.", en: "Switches the language of texts and labels in the Publication tab between German and English." } },
        ...
        bruteForceMetricSelect: { description: { de: "Wählen Sie die Zielmetrik, für deren Optimierungsergebnisse (via Brute-Force) die entsprechenden Statistiken im 'Ergebnisse'-Abschnitt des Publikation-Tabs dargestellt werden sollen.", en: "Select the target metric for which the optimization results (via Brute-Force) and corresponding statistics should be displayed in the 'Results' section of the Publication tab." } },
        methoden_studienanlage: { description: { de: "Informationen zu Studiendesign und Ethik.", en: "Information on study design and ethics." } },
        methoden_patientenkollektiv: { description: { de: "Details zum Patientenkollektiv.", en: "Details on the patient cohort." } },
        methoden_mrt_protokoll: { description: { de: "Informationen zum MRT-Protokoll und zur Kontrastmittelgabe.", en: "Information on MRI protocol and contrast administration." } },
        methoden_as_definition: { description: { de: "Informationen zur Definition und Bewertung des Avocado Signs.", en: "Information on the definition and assessment of the Avocado Sign." } },
        methoden_t2_definition: { description: { de: "Informationen zur Definition und Bewertung der T2-Kriterien (benutzerdefiniert, Literatur, Brute-Force optimiert).", en: "Information on the definition and assessment of T2 criteria (user-defined, literature, brute-force optimized)." } },
        methoden_referenzstandard: { description: { de: "Informationen zum Referenzstandard (Histopathologie).", en: "Information on the reference standard (histopathology)." } },
        methoden_statistische_analyse: { description: { de: "Informationen zu den statistischen Analysemethoden.", en: "Information on statistical analysis methods." } },
        ergebnisse_patientencharakteristika: { description: { de: "Relevante Tabellen/Diagramme zu den Patientencharakteristika.", en: "Relevant tables/charts on patient characteristics." } },
        ergebnisse_as_performance: { description: { de: "Relevante Tabellen/Diagramme zur diagnostischen Güte des Avocado Signs.", en: "Relevant tables/charts on the diagnostic performance of the Avocado Sign." } },
        ergebnisse_literatur_t2_performance: { description: { de: "Relevante Tabellen/Diagramme zur diagnostischen Güte der Literatur-basierten T2-Kriterien.", en: "Relevant tables/charts on the diagnostic performance of literature-based T2 criteria." } },
        ergebnisse_optimierte_t2_performance: { description: { de: "Relevante Tabellen/Diagramme zur diagnostischen Güte der Brute-Force optimierten T2-Kriterien.", en: "Relevant tables/charts on the diagnostic performance of brute-force optimized T2 criteria." } },
        ergebnisse_vergleich_performance: { description: { de: "Relevante Tabellen/Diagramme zum statistischen Vergleich der diagnostischen Güte zwischen Avocado Sign und den verschiedenen T2-Kriteriensets.", en: "Relevant tables/charts on the statistical comparison of diagnostic performance between the Avocado Sign and various T2 criteria sets." } }
    },
    statMetrics: { // Bereits zweisprachig in der vorherigen Antwort
        sens: { name: "Sensitivität", description: { de: "Sensitivität ([METHODE] vs. N): Anteil der tatsächlich positiven Fälle (N+), die durch die Methode [METHODE] korrekt als positiv erkannt wurden.<br><i>Formel: RP / (RP + FN)</i>", en: "Sensitivity ([METHODE] vs. N): Proportion of actual positive cases (N+) correctly identified by method [METHODE].<br><i>Formula: TP / (TP + FN)</i>" }, interpretation: { de: "Die Methode [METHODE] erkannte <strong>[WERT]</strong> der tatsächlich N+ Patienten korrekt (95% KI nach [METHOD_CI]: [LOWER] - [UPPER]) im Kollektiv [KOLLEKTIV].", en: "Method [METHODE] correctly identified <strong>[WERT]</strong> of actual N+ patients (95% CI by [METHOD_CI]: [LOWER] - [UPPER]) in cohort [KOLLEKTIV]." } },
        spez: { name: "Spezifität", description: { de: "Spezifität ([METHODE] vs. N): Anteil der tatsächlich negativen Fälle (N-), die durch die Methode [METHODE] korrekt als negativ erkannt wurden.<br><i>Formel: RN / (RN + FP)</i>", en: "Specificity ([METHODE] vs. N): Proportion of actual negative cases (N-) correctly identified by method [METHODE].<br><i>Formula: TN / (TN + FP)</i>" }, interpretation: { de: "Die Methode [METHODE] erkannte <strong>[WERT]</strong> der tatsächlich N- Patienten korrekt (95% KI nach [METHOD_CI]: [LOWER] - [UPPER]) im Kollektiv [KOLLEKTIV].", en: "Method [METHODE] correctly identified <strong>[WERT]</strong> of actual N- patients (95% CI by [METHOD_CI]: [LOWER] - [UPPER]) in cohort [KOLLEKTIV]." } },
        ppv: { name: "Pos. Prädiktiver Wert (PPV)", description: { de: "PPV ([METHODE] vs. N): Wahrscheinlichkeit, dass ein Patient mit einem positiven Testergebnis durch Methode [METHODE] tatsächlich krank (N+) ist.<br><i>Formel: RP / (RP + FP)</i>", en: "PPV ([METHODE] vs. N): Probability that a patient with a positive test result by method [METHODE] is actually N+.<br><i>Formula: TP / (TP + FP)</i>" }, interpretation: { de: "Wenn die Methode [METHODE] ein positives Ergebnis lieferte, lag die Wahrscheinlichkeit für einen tatsächlichen N+ Status bei <strong>[WERT]</strong> (95% KI nach [METHOD_CI]: [LOWER] - [UPPER]) im Kollektiv [KOLLEKTIV].", en: "If method [METHODE] yielded a positive result, the probability of an actual N+ status was <strong>[WERT]</strong> (95% CI by [METHOD_CI]: [LOWER] - [UPPER]) in cohort [KOLLEKTIV]." } },
        npv: { name: "Neg. Prädiktiver Wert (NPV)", description: { de: "NPV ([METHODE] vs. N): Wahrscheinlichkeit, dass ein Patient mit einem negativen Testergebnis durch Methode [METHODE] tatsächlich gesund (N-) ist.<br><i>Formel: RN / (RN + FN)</i>", en: "NPV ([METHODE] vs. N): Probability that a patient with a negative test result by method [METHODE] is actually N-.<br><i>Formula: TN / (TN + FN)</i>" }, interpretation: { de: "Wenn die Methode [METHODE] ein negatives Ergebnis lieferte, lag die Wahrscheinlichkeit für einen tatsächlichen N- Status bei <strong>[WERT]</strong> (95% KI nach [METHOD_CI]: [LOWER] - [UPPER]) im Kollektiv [KOLLEKTIV].", en: "If method [METHODE] yielded a negative result, the probability of an actual N- status was <strong>[WERT]</strong> (95% CI by [METHOD_CI]: [LOWER] - [UPPER]) in cohort [KOLLEKTIV]." } },
        acc: { name: "Accuracy (Gesamtgenauigkeit)", description: { de: "Accuracy ([METHODE] vs. N): Anteil aller Fälle, die durch die Methode [METHODE] korrekt klassifiziert wurden (sowohl positive als auch negative).<br><i>Formel: (RP + RN) / Gesamtanzahl</i>", en: "Accuracy ([METHODE] vs. N): Proportion of all cases correctly classified by method [METHODE] (both positive and negative).<br><i>Formula: (TP + TN) / Total</i>" }, interpretation: { de: "Die Methode [METHODE] klassifizierte insgesamt <strong>[WERT]</strong> aller Patienten korrekt (95% KI nach [METHOD_CI]: [LOWER] - [UPPER]) im Kollektiv [KOLLEKTIV].", en: "Method [METHODE] correctly classified a total of <strong>[WERT]</strong> of all patients (95% CI by [METHOD_CI]: [LOWER] - [UPPER]) in cohort [KOLLEKTIV]." } },
        balAcc: { name: "Balanced Accuracy", description: { de: "Balanced Accuracy ([METHODE] vs. N): Der Mittelwert aus Sensitivität und Spezifität.<br><i>Formel: (Sensitivität + Spezifität) / 2</i>", en: "Balanced Accuracy ([METHODE] vs. N): The average of sensitivity and specificity.<br><i>Formula: (Sensitivity + Specificity) / 2</i>" }, interpretation: { de: "Die Balanced Accuracy der Methode [METHODE], die Sensitivität und Spezifität gleich gewichtet, betrug <strong>[WERT]</strong> (95% KI nach [METHOD_CI]: [LOWER] - [UPPER]) im Kollektiv [KOLLEKTIV].", en: "The Balanced Accuracy of method [METHODE], which equally weights sensitivity and specificity, was <strong>[WERT]</strong> (95% CI by [METHOD_CI]: [LOWER] - [UPPER]) in cohort [KOLLEKTIV]." } },
        f1: { name: "F1-Score", description: { de: "F1-Score ([METHODE] vs. N): Das harmonische Mittel aus PPV (Precision) und Sensitivität (Recall).<br><i>Formel: 2 * (PPV * Sensitivität) / (PPV + Sensitivität)</i>", en: "F1-Score ([METHODE] vs. N): The harmonic mean of PPV (Precision) and Sensitivity (Recall).<br><i>Formula: 2 * (PPV * Sensitivity) / (PPV + Sensitivity)</i>" }, interpretation: { de: "Der F1-Score für die Methode [METHODE], der Präzision und Sensitivität kombiniert, beträgt <strong>[WERT]</strong> (95% KI nach [METHOD_CI]: [LOWER] - [UPPER]) im Kollektiv [KOLLEKTIV].", en: "The F1-Score for method [METHODE], combining precision and sensitivity, is <strong>[WERT]</strong> (95% CI by [METHOD_CI]: [LOWER] - [UPPER]) in cohort [KOLLEKTIV]." } },
        auc: { name: "Area Under Curve (AUC)", description: { de: "AUC ([METHODE] vs. N): Fläche unter der Receiver Operating Characteristic (ROC)-Kurve. Repräsentiert die Fähigkeit der Methode [METHODE], zufällig ausgewählte N+ und N- Patienten korrekt zu rangreihen. 0.5 entspricht Zufall, 1.0 perfekter Trennung.<br><i>Für binäre Tests (wie AS oder eine feste T2-Regel) ist AUC = Balanced Accuracy.</i>", en: "AUC ([METHODE] vs. N): Area under the Receiver Operating Characteristic (ROC) curve. Represents the ability of method [METHODE] to correctly rank randomly selected N+ and N- patients. 0.5 corresponds to chance, 1.0 to perfect separation.<br><i>For binary tests (like AS or a fixed T2 rule), AUC = Balanced Accuracy.</i>" }, interpretation: { de: "Die AUC von <strong>[WERT]</strong> (95% KI nach [METHOD_CI]: [LOWER] - [UPPER]) deutet auf eine <strong>[BEWERTUNG]</strong> generelle Trennschärfe der Methode [METHODE] zwischen N+ und N- Fällen im Kollektiv [KOLLEKTIV] hin.", en: "An AUC of <strong>[WERT]</strong> (95% CI by [METHOD_CI]: [LOWER] - [UPPER]) indicates a <strong>[BEWERTUNG_EN]</strong> overall discriminatory power of method [METHODE] between N+ and N- cases in cohort [KOLLEKTIV]." } },
        mcnemar: { name: "McNemar-Test", description: { de: "Prüft auf einen signifikanten Unterschied in den diskordanten Paaren (Fälle, bei denen AS und [T2_SHORT_NAME] unterschiedliche Ergebnisse liefern) bei gepaarten Daten.<br><i>Nullhypothese: Anzahl(AS+/[T2_SHORT_NAME]-) = Anzahl(AS-/[T2_SHORT_NAME]+)</i>", en: "Tests for a significant difference in discordant pairs (cases where AS and [T2_SHORT_NAME] yield different results) in paired data.<br><i>Null hypothesis: Number(AS+/[T2_SHORT_NAME]-) = Number(AS-/[T2_SHORT_NAME]+)</i>" }, interpretation: { de: "Der McNemar-Test ergab einen p-Wert von <strong>[P_WERT] ([SIGNIFIKANZ])</strong>. Dies deutet darauf hin, dass sich die Fehlklassifizierungsraten von AS und [T2_SHORT_NAME] im Kollektiv [KOLLEKTIV] [SIGNIFIKANZ_TEXT_DE] unterscheiden.", en: "McNemar's test yielded a p-value of <strong>[P_WERT] ([SIGNIFIKANZ_EN])</strong>. This suggests that the misclassification rates of AS and [T2_SHORT_NAME] in cohort [KOLLEKTIV] differ [SIGNIFIKANZ_TEXT_EN]." } },
        delong: { name: "DeLong-Test", description: { de: "Vergleicht zwei AUC-Werte von ROC-Kurven, die auf denselben (gepaarten) Daten basieren, unter Berücksichtigung der Kovarianz.<br><i>Nullhypothese: AUC(AS) = AUC([T2_SHORT_NAME])</i>", en: "Compares two AUC values from ROC curves based on the same (paired) data, considering covariance.<br><i>Null hypothesis: AUC(AS) = AUC([T2_SHORT_NAME])</i>" }, interpretation: { de: "Der DeLong-Test ergab einen p-Wert von <strong>[P_WERT] ([SIGNIFIKANZ])</strong>. Dies deutet darauf hin, dass sich die AUC-Werte (bzw. Balanced Accuracies) von AS und [T2_SHORT_NAME] im Kollektiv [KOLLEKTIV] [SIGNIFIKANZ_TEXT_DE] unterscheiden.", en: "DeLong's test yielded a p-value of <strong>[P_WERT] ([SIGNIFIKANZ_EN])</strong>. This suggests that the AUC values (or Balanced Accuracies) of AS and [T2_SHORT_NAME] in cohort [KOLLEKTIV] differ [SIGNIFIKANZ_TEXT_EN]." } },
        phi: { name: "Phi-Koeffizient (φ)", description: { de: "Maß für die Stärke und Richtung des Zusammenhangs zwischen zwei binären Variablen (z.B. Vorhandensein von Merkmal [MERKMAL] und N-Status). Wertebereich von -1 bis +1.", en: "Measure of the strength and direction of association between two binary variables (e.g., presence of feature [MERKMAL] and N-status). Range from -1 to +1." }, interpretation: { de: "Der Phi-Koeffizient von <strong>[WERT]</strong> deutet auf einen <strong>[STAERKE_DE]</strong> Zusammenhang zwischen dem Merkmal [MERKMAL] und dem N-Status im Kollektiv [KOLLEKTIV] hin.", en: "The Phi coefficient of <strong>[WERT]</strong> indicates a <strong>[STAERKE_EN]</strong> association between feature [MERKMAL] and N-status in cohort [KOLLEKTIV]." } },
        rd: { name: "Risk Difference (RD)", description: { de: "Absolute Differenz in der Wahrscheinlichkeit (Risiko) für N+ zwischen Patienten mit und ohne das Merkmal [MERKMAL].<br><i>Formel: P(N+|Merkmal+) - P(N+|Merkmal-)</i>", en: "Absolute difference in the probability (risk) of N+ between patients with and without feature [MERKMAL].<br><i>Formula: P(N+|Feature+) - P(N+|Feature-)</i>" }, interpretation: { de: "Das Risiko für N+ war um <strong>[WERT]%</strong> absolut [HOEHER_NIEDRIGER_DE] bei Patienten mit dem Merkmal [MERKMAL] verglichen mit Patienten ohne dieses Merkmal (95% KI nach [METHOD_CI]: [LOWER]% - [UPPER]%) im Kollektiv [KOLLEKTIV].", en: "The risk of N+ was <strong>[WERT]%</strong> absolutely [HOEHER_NIEDRIGER_EN] in patients with feature [MERKMAL] compared to patients without this feature (95% CI by [METHOD_CI]: [LOWER]% - [UPPER]%) in cohort [KOLLEKTIV]." } },
        or: { name: "Odds Ratio (OR)", description: { de: "Quotient der Odds für N+ bei Vorhandensein vs. Abwesenheit des Merkmals [MERKMAL].<br><i>Formel: Odds(N+|Merkmal+)/Odds(N+|Merkmal-)</i><br>OR > 1 bedeutet erhöhte Odds, OR < 1 verringerte Odds.", en: "Ratio of the odds of N+ in the presence vs. absence of feature [MERKMAL].<br><i>Formula: Odds(N+|Feature+)/Odds(N+|Feature-)</i><br>OR > 1 means increased odds, OR < 1 decreased odds." }, interpretation: { de: "Die Chance (Odds) für einen N+ Status war bei Patienten mit dem Merkmal [MERKMAL] um den Faktor <strong>[WERT]</strong> [FAKTOR_TEXT_DE] im Vergleich zu Patienten ohne dieses Merkmal (95% KI nach [METHOD_CI]: [LOWER] - [UPPER], p=[P_WERT], [SIGNIFIKANZ]) im Kollektiv [KOLLEKTIV].", en: "The odds of N+ status in patients with feature [MERKMAL] were <strong>[WERT]</strong> times [FAKTOR_TEXT_EN] compared to patients without this feature (95% CI by [METHOD_CI]: [LOWER] - [UPPER], p=[P_WERT], [SIGNIFIKANZ_EN]) in cohort [KOLLEKTIV]." } },
        fisher: { name: "Fisher's Exact Test", description: { de: "Exakter Test zur Prüfung auf einen signifikanten Zusammenhang zwischen zwei kategorialen Variablen (z.B. Merkmal [MERKMAL] vs. N-Status).", en: "Exact test to check for a significant association between two categorical variables (e.g., feature [MERKMAL] vs. N-status)." }, interpretation: { de: "Der exakte Test nach Fisher ergab einen p-Wert von <strong>[P_WERT] ([SIGNIFIKANZ])</strong>, was auf einen [SIGNIFIKANZ_TEXT_DE] Zusammenhang zwischen dem Merkmal [MERKMAL] und dem N-Status im Kollektiv [KOLLEKTIV] hindeutet.", en: "Fisher's exact test yielded a p-value of <strong>[P_WERT] ([SIGNIFIKANZ_EN])</strong>, suggesting a [SIGNIFIKANZ_TEXT_EN] association between feature [MERKMAL] and N-status in cohort [KOLLEKTIV]." } },
        mannwhitney: { name: "Mann-Whitney-U-Test", description: { de: "Nichtparametrischer Test zum Vergleich der zentralen Tendenz (Median) einer Variable (z.B. '[VARIABLE]') zwischen zwei unabhängigen Gruppen (z.B. N+ vs. N-).", en: "Nonparametric test to compare the central tendency (median) of a variable (e.g., '[VARIABLE]') between two independent groups (e.g., N+ vs. N-)." }, interpretation: { de: "Der Mann-Whitney-U-Test ergab einen p-Wert von <strong>[P_WERT] ([SIGNIFIKANZ])</strong>. Dies zeigt [SIGNIFIKANZ_TEXT_DE] Unterschied in der Verteilung der Variable '[VARIABLE]' zwischen N+ und N- Patienten im Kollektiv [KOLLEKTIV].", en: "The Mann-Whitney U test yielded a p-value of <strong>[P_WERT] ([SIGNIFIKANZ_EN])</strong>. This indicates [SIGNIFIKANZ_TEXT_EN] difference in the distribution of variable '[VARIABLE]' between N+ and N- patients in cohort [KOLLEKTIV]." } },
        ci95: { name: "95% Konfidenzintervall (CI)", description: { de: "Der Wertebereich, der den wahren (unbekannten) Wert der Population für die berechnete Metrik mit einer Wahrscheinlichkeit von 95% überdeckt.<br><i>Methode: [METHOD_CI]</i>", en: "The range of values that covers the true (unknown) population value for the calculated metric with 95% probability.<br><i>Method: [METHOD_CI]</i>" }, interpretation: { de: "Basierend auf den Daten liegt der wahre Wert der Metrik mit 95%iger Sicherheit zwischen [LOWER] und [UPPER].", en: "Based on the data, the true value of the metric is between [LOWER] and [UPPER] with 95% confidence." } },
        ...
        accComp: { name: "Accuracy Vergleich", description: { de: "Vergleicht die Accuracy der Methode [METHODE] zwischen zwei unabhängigen Kollektiven ([KOLLEKTIV1] vs. [KOLLEKTIV2]) mittels Fisher's Exact Test.", en: "Compares the accuracy of method [METHODE] between two independent cohorts ([KOLLEKTIV1] vs. [KOLLEKTIV2]) using Fisher's Exact Test." }, interpretation: { de: "Der Unterschied in der Accuracy der Methode [METHODE] zwischen den Kollektiven [KOLLEKTIV1] und [KOLLEKTIV2] ist <strong>[SIGNIFIKANZ_TEXT_DE]</strong> (p=[P_WERT]).", en: "The difference in accuracy of method [METHODE] between cohorts [KOLLEKTIV1] and [KOLLEKTIV2] is <strong>[SIGNIFIKANZ_TEXT_EN]</strong> (p=[P_WERT])." } },
        aucComp: { name: "AUC Vergleich", description: { de: "Vergleicht die AUC der Methode [METHODE] zwischen zwei unabhängigen Kollektiven ([KOLLEKTIV1] vs. [KOLLEKTIV2]) mittels eines Z-Tests.", en: "Compares the AUC of method [METHODE] between two independent cohorts ([KOLLEKTIV1] vs. [KOLLEKTIV2]) using a Z-test." }, interpretation: { de: "Der Unterschied in der AUC der Methode [METHODE] zwischen den Kollektiven [KOLLEKTIV1] und [KOLLEKTIV2] ist <strong>[SIGNIFIKANZ_TEXT_DE]</strong> (p=[P_WERT]).", en: "The difference in AUC of method [METHODE] between cohorts [KOLLEKTIV1] and [KOLLEKTIV2] is <strong>[SIGNIFIKANZ_TEXT_EN]</strong> (p=[P_WERT])." } },
        logisticRegressionFit: { name: "Modellanpassung (Log. Regression)", description: { de: "Güte der Anpassung des logistischen Regressionsmodells an die Daten.", en: "Goodness of fit of the logistic regression model to the data." }, interpretation: { de: "Das Modell zeigt eine [BEWERTUNG_FIT] Anpassung an die Daten.", en: "The model shows a [BEWERTUNG_FIT_EN] fit to the data." } },
        logisticRegressionCoef: { name: "Koeffizient (Log. Regression)", description: { de: "Geschätzter Koeffizient für den Prädiktor [PREDICTOR]. Gibt die Veränderung der Log-Odds für N+ pro Einheitsänderung des Prädiktors an.", en: "Estimated coefficient for predictor [PREDICTOR]. Indicates the change in log-odds for N+ per unit change in the predictor." }, interpretation: { de: "Der Koeffizient für [PREDICTOR] beträgt <strong>[COEF_VALUE]</strong> (p=[P_WERT], [SIGNIFIKANZ]), was auf einen [SIGNIFIKANZ_TEXT_DE] Einfluss auf die N+ Wahrscheinlichkeit hindeutet.", en: "The coefficient for [PREDICTOR] is <strong>[COEF_VALUE]</strong> (p=[P_WERT], [SIGNIFIKANZ_EN]), suggesting a [SIGNIFIKANZ_TEXT_EN] influence on the N+ probability." } },
        ...
        defaultP: { interpretation: { de: `Der berechnete p-Wert beträgt <strong>[P_WERT] ([SIGNIFIKANZ])</strong>. Bei einem Signifikanzniveau von ${APP_CONFIG.STATISTICAL_CONSTANTS.SIGNIFICANCE_LEVEL} ist das Ergebnis <strong>[SIGNIFIKANZ_TEXT_DE]</strong>.`, en: `The calculated p-value is <strong>[P_WERT] ([SIGNIFIKANZ_EN])</strong>. At a significance level of ${APP_CONFIG.STATISTICAL_CONSTANTS.SIGNIFICANCE_LEVEL}, the result is <strong>[SIGNIFIKANZ_TEXT_EN]</strong>.` } }
    }
};
