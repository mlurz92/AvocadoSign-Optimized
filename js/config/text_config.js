...
const UI_TEXTS = {
    ...
    legendLabels: {
        ...
        currentT2: '{T2ShortName}', // Wird dynamisch ersetzt
        benignLN: 'Benigne LK',
    ...
    excelExport: { // Veraltet, da XLSX nicht implementiert ist, aber zur Vollständigkeit belassen
...
const TOOLTIP_CONTENT = {
    ...
    datenTable: {
        ...
        geschlecht: "Geschlecht des Patienten (m/w/unbekannt).",
        ...
        n_as_t2: "Direkter Vergleich des Lymphknotenstatus: N (Pathologie-Referenz), AS (Avocado Sign Vorhersage), T2 (Vorhersage basierend auf aktuell angewendeten Kriterien). Klicken Sie auf N, AS oder T2 in der Spaltenüberschrift, um nach diesem spezifischen Status zu sortieren.",
        ...
        expandRow: "Klicken Sie auf diese Zeile oder den Pfeil-Button, um Details zu den morphologischen Eigenschaften der T2-gewichteten Lymphknoten dieses spezifischen Patienten anzuzeigen oder auszublenden."
    },
    auswertungTable: {
        nr: "Fortlaufende Nummer des Patienten.",
        name: "Nachname des Patienten (anonymisiert/kodiert).",
        ...
        expandRow: "Klicken Sie auf diese Zeile oder den Pfeil-Button, um die detaillierte Bewertung der einzelnen T2-gewichteten Lymphknoten dieses Patienten gemäß der aktuell angewendeten Kriterien anzuzeigen oder auszublenden. Erfüllte Positiv-Kriterien werden hervorgehoben."
    },
    ...
    bruteForceDetailsButton: { description: "Öffnet ein separates Fenster (Modal), das eine sortierte Liste der Top 10 gefundenen Kriterienkombinationen (inklusive solcher mit gleichem Metrikwert) und weitere Details zur Optimierung (inkl. Kollektiv-Statistik) anzeigt." },
    bruteForceModal: { exportButton: "Exportiert den detaillierten Bericht der Brute-Force-Optimierung, inklusive der Top 10 Ergebnisse, der Kollektiv-Statistik und der Konfiguration, als formatierte Textdatei (.txt)." },
    ...
    deskriptiveStatistik: {
        ...
        geschlecht: { description: "Absolute Anzahl und prozentuale Verteilung der Geschlechter (männlich/weiblich/unbekannt) im Kollektiv." },
        ...
        age: { name: "Alter", description: "Alter des Patienten in Jahren." }, // Generic for charts
        gender: { name: "Geschlecht", description: "Geschlecht des Patienten." } // Generic for charts
    },
    ...
    criteriaComparisonTable: {
        cardTitle: "Tabellarischer Vergleich der diagnostischen Güte verschiedener Methoden/Kriteriensätze (AS, aktuell angewandte T2, Studien) für das globale Kollektiv [KOLLEKTIV]. Werte für Literatur-Kriteriensätze werden auf deren spezifischem Zielkollektiv berechnet, falls abweichend.",
        tableHeaderSet: "Methode / Kriteriensatz (Basis-Kollektiv N)",
    ...
    praesentation: {
        viewSelect: { description: "Wählen Sie die Datenansicht für den Präsentations-Tab: 'Avocado Sign (Daten)' zeigt die dynamisch berechneten Kernergebnisse für AS im aktuellen Kollektiv. 'AS vs. T2 (Vergleich)' ermöglicht einen dynamischen Vergleich von AS mit T2-Kriterien. Das globale Kollektiv wird ggf. automatisch angepasst, um dem Zielkollektiv der gewählten T2-Studie zu entsprechen." },
        studySelect: { description: "Wählen Sie eine Quelle für die T2-Kriterien, die mit dem Avocado Sign verglichen werden sollen: Entweder die aktuell in der App eingestellten ('Eingestellte T2 Kriterien') oder vordefinierte Kriteriensätze aus relevanten publizierten Studien. Die Auswahl aktualisiert die Info-Karte und den Vergleichs-Chart. Das globale Kollektiv wird ggf. automatisch angepasst." },
        t2BasisInfoCard: {
            title: "Details zur T2-Vergleichsbasis",
            description: "Zeigt Details zu den aktuell für den Vergleich ausgewählten T2-Kriterien und dem für den Vergleich verwendeten Patientenkollektiv.",
            reference: "Quelle / Publikation der Kriterien.",
            patientCohort: "Ursprüngliche Kohorte und Untersuchungstyp der Studie bzw. aktuelles Vergleichskollektiv.",
        ...
        comparisonTableCard: { description: "Zeigt die numerischen Werte der diagnostischen Gütekriterien für den Vergleich von Avocado Sign vs. ausgewählter T2-Basis für das Vergleichskollektiv."},
    ...
    exportTab: {
        ...
        bruteForceTXT: { description: "Exportiert den detaillierten Bericht der letzten Brute-Force-Optimierung für das aktuelle Kollektiv (Top 10 Ergebnisse, Kollektiv-Statistik, Konfiguration, Laufzeit) als reine Textdatei (.txt), falls eine Optimierung durchgeführt wurde.", type: 'BRUTEFORCE_TXT', ext: "txt" },
        ...
        chartsSVG: { description: "Exportiert alle aktuell sichtbaren Diagramme aus dem Statistik-, Auswertung- und Präsentationstab als einzelne, skalierbare Vektorgrafik-Dateien (SVG), gebündelt in einem ZIP-Archiv.", type: 'SVG_ZIP', ext: "svg" },
    ...
    publikationTabTooltips: {
        ...
        bruteForceMetricSelect: { description: "Wählen Sie die Zielmetrik, für deren Optimierungsergebnisse (via Brute-Force) die entsprechenden Statistiken im 'Ergebnisse'-Abschnitt des Publikation-Tabs dargestellt werden sollen. Beachten Sie, dass die Haupttexte sich i.d.R. auf die Standard-BF-Metrik beziehen." },
        methoden: {
    ...
    statMetrics: {
        ...
        size_mwu: {name: "LK Größe MWU", description: "Vergleich der medianen Lymphknotengrößen zwischen N+ und N- Patienten mittels Mann-Whitney-U-Test.", interpretation: "Der Mann-Whitney-U-Test ergab einen p-Wert von <strong>[P_WERT] ([SIGNIFIKANZ])</strong>. Dies zeigt [SIGNIFIKANZ_TEXT] Unterschied in der Verteilung der Lymphknotengrößen zwischen N+ und N- Patienten im Kollektiv [KOLLEKTIV]."}
    }
};
