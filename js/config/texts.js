...
const UI_TEXTS = {
    ...
    t2CriteriaShortPrefix: {
        ...
        homogenitaet: { de: 'Ho=', en: 'Homog.=' },
        signal: { de: 'Si=', en: 'Signal=' }
    },
    ...
    legendLabels: {
        ...
        currentT2: { de: '{T2Label}', en: '{T2Label}' },
    ...
    criteriaComparison: {
        ...
        tableHeaderSet: { de: "Methode / Kriterienset", en: "Method / Criteria Set"},
    ...
    literatureSetNames: {
        'rutegard_et_al_esgar': {de: 'Rutegård et al. (2025) / ESGAR 2016', en: 'Rutegård et al. (2025) / ESGAR 2016'},
        'koh_2008_morphology': {de: 'Koh et al. (2008)', en: 'Koh et al. (2008)'},
        'barbaro_2024_restaging': {de: 'Barbaro et al. (2024)', en: 'Barbaro et al. (2024)'}
    },
    excelExport: {
        ...
        zipLabel: {de: "Alle Excel-Tabellen (.zip)", en: "All Excel Tables (.zip)"}
    },
    singleChartDownload: {
    ...
    publicationTableTitles: {
        ...
        criteriaComparison: {de: 'Tabelle X: Vergleich der diagnostischen Güte verschiedener Kriteriensätze (vs. N) für Kollektiv: [KOLLEKTIV]', en: 'Table X: Comparison of diagnostic performance of different criteria sets (vs. N) for cohort: [KOLLEKTIV]'}
    },
...
const TOOLTIP_CONTENT = {
    ...
    statMetrics: {
        ...
        mcnemar: { name: {de: "McNemar-Test", en: "McNemar's Test"}, description: {de: "Prüft auf einen signifikanten Unterschied in den diskordanten Paaren (Fälle, bei denen AS und [T2_SHORT_NAME] unterschiedliche Ergebnisse liefern) bei gepaarten Daten.<br><i>Nullhypothese: Anzahl(AS richtig/[T2_SHORT_NAME] falsch) = Anzahl(AS falsch/[T2_SHORT_NAME] richtig) bezogen auf den Goldstandard.</i>", en: "Tests for a significant difference in discordant pairs (cases where AS and [T2_SHORT_NAME] yield different results relative to the gold standard) in paired data.<br><i>Null hypothesis: Count(AS correct/[T2_SHORT_NAME] incorrect) = Count(AS incorrect/[T2_SHORT_NAME] correct) relative to gold standard.</i>"}, interpretation: {de: "Der McNemar-Test ergab einen p-Wert von <strong>[P_WERT] ([SIGNIFIKANZ])</strong>. Dies deutet darauf hin, dass sich die Fehlklassifizierungsraten (Accuracy) von AS und [T2_SHORT_NAME] im Kollektiv [KOLLEKTIV] [SIGNIFIKANZ_TEXT] unterscheiden.", en: "McNemar's test yielded a p-value of <strong>[P_WERT] ([SIGNIFIKANZ])</strong>. This suggests that the misclassification rates (accuracy) of AS and [T2_SHORT_NAME] in cohort [KOLLEKTIV] differ [SIGNIFIKANZ_TEXT]."} },
