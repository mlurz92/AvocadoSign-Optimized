...
const UI_TEXTS = {
    ...
    publikationTab: {
        ...
        navMethoden: 'Methoden',
        navErgebnisse: 'Ergebnisse',
        navDiskussion: 'Diskussion (Platzhalter)',
        navEinleitung: 'Einleitung (Platzhalter)',
        navAbstract: 'Abstract (Platzhalter)',
        navReferenzen: 'Referenzen (Platzhalter)'
    },
    chartTitles: {
    ...
    excelExport: {
        patientenLabel: "Datenübersicht (.xlsx)",
...
const TOOLTIP_CONTENT = {
    ...
    exportTab: {
        ...
        patientenMD: { description: "Exportiert die aktuelle Datenübersicht (aus dem Daten-Tab) als Markdown-Tabelle (.md).", type: 'PATIENTEN_MD', ext: "md" }, // Angepasst von Patientenliste
        patientenXLSX: { description: "Exportiert die aktuelle Datenübersicht (aus dem Daten-Tab) als Excel-Datei (.xlsx).", type: 'PATIENTEN_XLSX', ext: "xlsx" }, // Angepasst
        ...
        mdZIP: { description: "Bündelt alle verfügbaren Markdown-Dateien (Deskriptiv, Daten, Auswertung) in einem ZIP-Archiv.", type: 'MD_ZIP', ext: "md"}, // Angepasst
    ...
    publikationTabContent: { // NEU
        langSwitch: { description: "Wechselt die Sprache der Publikationsabschnitte zwischen Deutsch und Englisch." },
        navMethodenTooltip: "Zeigt den Methodenteil der Publikation.",
        navErgebnisseTooltip: "Zeigt den Ergebnisteil der Publikation.",
        publicationCardTitle: "Publikationsentwurf: {Abschnitt}",
        methoden: {
            title: "Methoden",
            studyDesignPatients: { title: "Studiendesign und Patientenkollektiv", cardTooltip: "Informationen zum Design der Studie und den Charakteristika der eingeschlossenen Patienten." },
            mriProtocolAnalysis: { title: "MRT-Protokoll und Bildanalyse", cardTooltip: "Details zum verwendeten MRT-Protokoll und zur Methodik der Bildanalyse für das Avocado Sign und die T2-Kriterien." },
            histopathologicalAnalysis: { title: "Histopathologische Analyse", cardTooltip: "Beschreibung der histopathologischen Aufarbeitung als Referenzstandard." },
            statisticalAnalysis: { title: "Statistische Analyse", cardTooltip: "Übersicht der angewandten statistischen Methoden und Tests." }
        },
        ergebnisse: {
            title: "Ergebnisse",
            patientCharacteristics: { title: "Patientencharakteristika", cardTooltip: "Deskriptive Statistik des Studienkollektivs." },
            diagnosticPerformance: { title: "Diagnostische Güte: Avocado Sign vs. T2-Kriterien", cardTooltip: "Vergleichende Darstellung der diagnostischen Leistung." },
            literatureCriteriaComparison: { title: "Vergleich mit Literatur-basierten T2-Kriterien", cardTooltip: "Performance des Avocado Signs im Vergleich zu etablierten T2-Kriterien aus der Literatur." },
            bruteforceOptimizedCriteria: { title: "Vergleich mit Brute-Force optimierten T2-Kriterien", cardTooltip: "Performance des Avocado Signs im Vergleich zu datengetriebenen, optimierten T2-Kriterien." }
        }
    },
    statMetrics: {
