    ...
    UI_TEXTS: {
        ...
        kurzanleitung: {
            ...
            content: `
                ...
                <ul>
                    ...
                    <li>**Statistische Signifikanz:** In statistischen Tabellen werden p-Werte mit Symbolen für Signifikanzniveaus versehen: * p &lt; 0.05, ** p &lt; 0.01, *** p &lt; 0.001. Das zugrundeliegende Signifikanzniveau ist &alpha; = ${formatNumber(0.05,2).replace('.',',')}.</li>
                </ul>
        ...
        TOOLTIP_CONTENT: {
            ...
            statMetrics: {
                ...
                phi: { name: "Phi-Koeffizient (φ)", description: "Maß für die Stärke und Richtung des Zusammenhangs zwischen zwei binären Variablen (z.B. Vorhandensein von Merkmal '[MERKMAL]' und N-Status). Wertebereich von -1 bis +1. 0 bedeutet kein Zusammenhang.", interpretation: "Der Phi-Koeffizient von **[WERT]** deutet auf einen **[BEWERTUNG]** Zusammenhang zwischen dem Merkmal '[MERKMAL]' und dem N-Status im Kollektiv [KOLLEKTIV] hin."},
