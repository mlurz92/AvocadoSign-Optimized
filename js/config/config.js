const APP_CONFIG = Object.freeze({
    ...
    STORAGE_KEYS: Object.freeze({
        APPLIED_CRITERIA: 'appliedT2Criteria_v2.2.0',
        APPLIED_LOGIC: 'appliedT2Logic_v2.2.0',
        CURRENT_KOLLEKTIV: 'currentKollektiv_v2.2.0',
        PUBLIKATION_LANG: 'currentPublikationLang_v2.2.0',
        PUBLIKATION_SECTION: 'currentPublikationSection_v2.2.0',
        PUBLIKATION_BRUTE_FORCE_METRIC: 'currentPublikationBfMetric_v2.2.0',
        STATS_LAYOUT: 'currentStatsLayout_v2.2.0',
        STATS_KOLLEKTIV1: 'currentStatsKollektiv1_v2.2.0',
        STATS_KOLLEKTIV2: 'currentStatsKollektiv2_v2.2.0',
        PRESENTATION_VIEW: 'currentPresentationView_v2.2.0',
        PRESENTATION_STUDY_ID: 'currentPresentationStudyId_v2.2.0',
        CRITERIA_COMPARISON_SETS: 'criteriaComparisonSets_v2.2.0',
        CHART_COLOR_SCHEME: 'chartColorScheme_v2.2.0',
        AGGREGATED_BRUTE_FORCE_RESULTS: 'aggregatedBruteForceResults_v2.2.0_optimized'
    }),
    ...
    EXPORT_SETTINGS: Object.freeze({
        ...
        FILENAME_TYPES: Object.freeze({
            ...
            PRAES_AS_VS_T2_PERF_CSV: 'Praes_ASvsT2_{StudyID}_Performance_CSV',
            PRAES_AS_VS_T2_COMP_MD: 'Praes_ASvsT2_{StudyID}_Metrics_MD',
            PRAES_AS_VS_T2_TESTS_MD: 'Praes_ASvsT2_{StudyID}_Tests_MD',
            PRAES_AS_VS_T2_CHART_PNG: 'Praes_ASvsT2_{StudyID}_Chart_PNG',
            PRAES_AS_VS_T2_CHART_SVG: 'Praes_ASvsT2_{StudyID}_Chart_SVG',
